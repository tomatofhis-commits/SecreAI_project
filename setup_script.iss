...
OutputBaseFilename=SecreAI_v0.9.7_Setup
...
[Files]
; The main executable
Source: "C:\Users\amach\OneDrive\デスクトップ\アップ用作業\SecreAI_ver0.9.7\{#MyAppExeName}"; DestDir: "{app}"; Flags: ignoreversion
; All other files in the dist folder
Source: "C:\Users\amach\OneDrive\デスクトップ\アップ用作業\SecreAI_ver0.9.7\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
