...
OPTIMIZED_CONFIG = {
    ...
    "MODEL_OPTIMIZATION": {
        ...
        # タスク別モデル設定
        "TASK_MODELS": {
            "chat": "gemini-3.8-flash",  # 通常会話
            "vision": "gemini-3.8-flash",  # 画像分析
            "analysis": "gemini-3.1-pro-preview",  # 複雑な分析
            "summary": "gemma3:4b",  # ローカル要約(無料)
            "feedback": "gemini-3.8-flash（中）"  # フィードバック分析
        }
    }
}
...
PERFORMANCE_MODE = {
    "AI_PROVIDER": "gemini",
    "MODEL_ID": "gemini-3.8-flash",  # 最高性能
    "search_switch": True,
...
BALANCED_MODE = {
    "AI_PROVIDER": "gemini",
    "MODEL_ID": "gemini-3.8-flash",  # コスパ良好
