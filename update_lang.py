...
translations = {
    "ja": {
        ...
        "search_opt_grounding_3_1": "gemini-3.1-flash-lite-previewのgrounding (思考最小)",
    ...
    "en": {
        ...
        "search_opt_grounding_3_1": "gemini-3.1-flash-lite-preview grounding (Minimal thinking)",
        "setting_group_gemini": " Gemini Settings ", "setting_group_openai": " OpenAI Settings ", "setting_group_llama": " Llama (Local Ollama) Settings ",
        "label_local_model_id": "Local Model ID:", "label_ollama_endpoint": "Ollama Endpoint:",
        "tab_extensions_title": "Extensions (Experimental)", "extensions_group_api": " API / WebSockets ",
    ...
    "zh-CN": {
        ...
        "search_opt_grounding_3_1": "gemini-3.1-flash-lite-preview grounding (最小思考)",
    ...
    "ko": {
        "deprecation_notice": "⚠ Gemini 2.5 시리즈 종료 예정일\nGemini 2.5 Flash: 2026년 6월 17일 / Gemini 2.5 Flash-Lite: 2026년 7월 22일",
        "thinking_level_label": "사고 레벨 (3.1-flash-lite 전용):",
        ...
        "search_opt_grounding_3_1": "gemini-3.1-flash-lite-preview grounding (최소 사고)",
    ...
    "es": {
        ...
        "search_opt_grounding_3_1": "gemini-3.1-flash-lite-preview grounding (Pensamiento mínimo)",
    ...
    "fr": {
        ...
        "search_opt_grounding_3_1": "gemini-3.1-flash-lite-preview grounding (Réflexion minimale)",
    ...
    "de": {
        ...
        "search_opt_grounding_3_1": "gemini-3.1-flash-lite-preview grounding (Minimales Denken)",
    ...
    "it": {
        ...
        "search_opt_grounding_3_1": "gemini-3.1-flash-lite-preview grounding (Pensiero minimo)",
    ...
    "pt": {
        ...
        "search_opt_grounding_3_1": "gemini-3.1-flash-lite-preview grounding (Raciocínio mínimo)",
    ...
    "ru": {
        ...
        "search_opt_grounding_3_1": "gemini-3.1-flash-lite-preview grounding (Минимальное мышление)",
